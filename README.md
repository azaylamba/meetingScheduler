...
You have to design & build the backend for the application and the ability for the users to register, check the calendar of other users and send meeting invites.
...
https://github.com/azaylamba/meetingScheduler 
